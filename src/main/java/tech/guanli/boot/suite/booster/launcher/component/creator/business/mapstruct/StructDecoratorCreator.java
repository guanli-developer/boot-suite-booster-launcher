...
@Component
public class StructDecoratorCreator extends BasicBusinessCreator {
	...
	public void create() {
		...
		try (FileWriter fileWriter = new FileWriter(new File(basePackageGenerator.getBasePackage() + File.separator
				+ "mapstruct" + File.separator + model.getName() + "StructDecorator.java"));) {
			Configuration configuration = configurationFactory.createConfiguration();
			Template template = configuration.getTemplate("StructDecorator.ftl");
