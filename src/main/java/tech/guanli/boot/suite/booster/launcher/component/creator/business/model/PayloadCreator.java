...
@Component
public class PayloadCreator extends BasicBusinessCreator {
	...
	public void create() {
		...
		try (FileWriter fileWriter = new FileWriter(new File(basePackageGenerator.getBasePackage() + File.separator
				+ "model" + File.separator + "payload" + File.separator + model.getName() + "Payload.java"));) {
			Configuration configuration = configurationFactory.createConfiguration();
			Template template = configuration.getTemplate("Payload.ftl");
